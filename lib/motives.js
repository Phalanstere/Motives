...
this.paint_project_info = function(project){
	...
	s = '<div id = "info">' + project.title + '</div>';
...
this.new_project = function() {
	$(".association").remove();
	self.associations = [];
	var title = prompt("Please enter the name of the project", "");
    if (title !== null) {
		if (self.check_title(title) === false) {
		self.title = title;
...
this.menu = function(){
    ...
    s = '<div id = "new_association" class = "motives_block">item</div>';
    // $("#" + self.menu_id).append(s);


    s += '<div id = "new_project" class = "motives_block">new_project</div>';
    // s += '<div id = "save_project" class = "motives_block">save</div>';
    s += '<div id = "delete_project" class = "motives_block">delete_project</div>';
    
    s += '<div id = "association_json" class = "motives_block">json_export</div>';
    ...
    s += '<select id = "select_project"></select>';

    s += '<div id = "search">';        
		s += '<input id="fulltext_search" value= "search text"/>';
		s += '<input id="tag_search" value= "search tags"/>';		
	s += '</div>';        
...
this.save_ndb = function(project) {
