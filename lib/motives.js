...
this.menu = function(){
    ...
    s += '<div id = "association_new_project" class = "motives_block">new</div>';
...
this.save_project = function() {
	...
	self.db.update({ title: self.title }, { $set: { associations: self.associations } }, { multi: true }, function (err, numReplaced) {
