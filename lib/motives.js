...
this.new_association = function() {
  ...
  s = '<div id = "AssociationInput">';
    ...
    s += '<label for="AssocAbstract">abstract<textarea rows="4" cols="50">At w3schools.com you will learn how to make a website.</textarea><label><br>'; 

   
    s += '<label for="AssocAbstract">fulltext<textarea rows="6" cols="50">At w3schools.com you will learn how to make a website.</textarea><label><br>'; 
                
    // s += '<input type="file" id="files" visbility="hidden"/>';

    s += '<label for="AssocLink">link<input id="AssocLink"></label>';
